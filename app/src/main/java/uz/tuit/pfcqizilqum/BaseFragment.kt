package uz.jameschamberlain.footballteamtracker
...
open class BaseFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        inflater.inflate(com.tuit.pcfqizilqum.R.menu.main_options_menu, menu)
    }
    ...
    fun completeTeamCodeAction() {
        ...
        MaterialAlertDialogBuilder(requireContext()).apply {
            setTitle(getString(com.tuit.pcfqizilqum.R.string.team_code))
            setMessage(teamCode)
